...
1. Install flask, yt_dlp and tekore using the commands one-by-one
          ...
          pip install flask
          pip install tekore
2. Go to https://www.gyan.dev/ffmpeg/builds/ and install "Essentials" zip, extract it into a folder and copy the path to /bin folder inside it.
...
4. Copy your client id. client secret and the path given above and paste it at the required position in mainwebapp.py(highlighted by comments).
